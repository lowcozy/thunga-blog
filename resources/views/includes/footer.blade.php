            ...
            <div class="contacts">
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="javascript:void(0)" class="title">{{ $settings->contact_number }}</a>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="javascript:void(0)" class="title">{{ $settings->contact_email }}</a>
                            <p class="sub-title">Hỗ trợ online</p>
                        </div>
                    </div>
                </div>
            </div>
